...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.evView = QtWidgets.QTreeView(self.dockWidgetContents_5)
        ...
        self.menuOPC_UA_Client.addAction(self.actionUnsubscribe)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionUnsubscribe.setToolTip(_translate("MainWindow", "Unsubscribe to current node"))
